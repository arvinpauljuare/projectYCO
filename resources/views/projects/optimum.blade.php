...
@section('content')
	<!-- BANNER -->
  	<div class="bannerBG">
    	<div class="asTitleCont text-center">
      		<span class="asTitle">TheOptimum R. Fit-out Inc.</span>
    	</div>
  	</div>
    ...
    <div style="" id="aboutUsHeader">
      <div class="asProfContHeader" style="">
          <div class="row text-center" style="padding-top: 0px;">
            <div class="visionMissionTextHeader">
              <span>TheOptimum R. Fit-out Inc. is a business under YCOptimum Holdings Inc. specializing in fit-out and renovation of residential, offices, & retail/commercial spaces.</span>
            </div>
          </div>
      </div>
      <!-- PROJECTS SELECTION -->
      <div id="" style="padding: 20px 105px 0px 105px;">
        <div class="row text-center">
          <div class="col-md-4">
            <button id="residentialProjOpt" class="btn btn-default form-control" style="height: 50px;">
              <span style="font-weight: bold">RESIDENTIAL</span>
            </button>
          </div>
          <div class="col-md-4">
            <button id="officeProjOpt" class="btn btn-default form-control" style="height: 50px;">
              <span style="font-weight: bold">OFFICES</span>
            </button>
          </div>
          <div class="col-md-4">
            <button id="retailProjOpt" class="btn btn-default form-control" style="height: 50px;">
  ...
  <div id="residentialProjContainer" style="padding: 0px 100px 40px 100px;"></div>
  <div id="officeProjContainer" style="padding: 0px 100px 40px 100px;"></div>
  <div id="retailProjContainer" style="padding: 0px 100px 40px 100px;"></div>

	<!-- CONTACT US -->
  <form action="mailto:{{ $ycoInfo->email }}" method="post" enctype="text/plain">
  	<div class="asCSCont" id="projectsContact" style="background-color: white">
