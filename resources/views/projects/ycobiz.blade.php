	...
	<!-- BANNER -->
  	<div class="bannerBG">
    	<div class="asTitleCont text-center">
      		<span class="asTitle">YCOptimum Business Solutions</span>
    	</div>
  	</div>
  ...
  <div style="" id="aboutUsHeader">
      ...
      <div id="" style="padding: 20px 105px 0px 105px;">
        <div class="row text-center">
          <div class="col-md-4">
            <button id="residentialProjYB" class="btn btn-default form-control" style="height: 50px;">
              <span style="font-weight: bold">RESIDENTIAL</span>
            </button>
          </div>
          <div class="col-md-4">
            <button id="officeProjYB" class="btn btn-default form-control" style="height: 50px;">
              <span style="font-weight: bold">OFFICES</span>
            </button>
          </div>
          <div class="col-md-4">
            <button id="retailProjYB" class="btn btn-default form-control" style="height: 50px;">
